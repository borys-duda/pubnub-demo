...
+ (id)dataWithDictionary:(NSDictionary *)data type:(NSBubbleType)type
{
    ...
    NSString *datetime  = [data objectForKey:@"timestamp"];
    
    NSDateFormatter *dateFormat = [[NSDateFormatter alloc] init];
    [dateFormat setDateFormat:@"yyyy-MM-dd hh:mm:ss"];
    NSDate *date = [dateFormat dateFromString:datetime];
    
    NSBubbleData *bubbleData = [[NSBubbleData alloc] initWithText:message date:date type:type];
    bubbleData.sender = sender;
